...
Widget wrapWithModel<T extends SwiftFlutterFlowModel>({
  required T model,
...
T createModel<T extends SwiftFlutterFlowModel>(
...
abstract class SwiftFlutterFlowModel {
  ...
  SwiftFlutterFlowModel setOnUpdate({
    bool updateOnChange = false,
...
class FlutterFlowDynamicModels<T extends SwiftFlutterFlowModel> {
